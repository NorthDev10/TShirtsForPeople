...
export default {
  ...
  methods: {
    selectedPiece(value) {
      for(let selectedPiece in this.tshirtPieceList) {
...
<style lang="scss" scoped>
  ...
  @media screen and (max-width: 1024px) {
    ...
    .selected-piece {
      stroke-width: 2;
      animation: blink-color 800ms infinite alternate;
    }
  }
</style>